...
The main configuration class is link:{Aether_scala}[`Aether.scala`].

include::{Aether_scala}[]

For repository configurations, the {Repository_scala} class is used.
For advanced dependency configuration, see the {Dependency_scala} class.
